The approximate Q-learning agent can be found in the ASSIGNMENTS directory. Running the following code in the python terminal will generate the results used for the project:
